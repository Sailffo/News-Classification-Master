...
class TextConfig():
    ...
    train_filename=r'D:\AI\MachineLearing\text-cnn-master\data\cnews.train.txt'  #train data
    test_filename=r'D:\AI\MachineLearing\text-cnn-master\data\cnews.test.txt'    #test data
    val_filename=r'D:\AI\MachineLearing\text-cnn-master\data\cnews.val.txt'      #validation data
    vocab_filename=r'D:\AI\MachineLearing\text-cnn-master\data\vocab.txt'        #vocabulary
    vector_word_filename=r'D:\AI\MachineLearing\text-cnn-master\data\vector_word.txt'  #vector_word trained by word2vec
    vector_word_npz=r'D:\AI\MachineLearing\text-cnn-master\data\vector_word.npz'   # save vector_word to numpy file
